...
export function routeToCall(){
  ...
  switch(true) {
    ...
    case !utils.getGlobalVariable('appSettings'):
      utils.loadSystemFile( 'appSettings', '../js.cms.settings/appSettings.json' , routeToCall );
    break;
    /** Page loader - init variables **/
    case !utils.getGlobalVariable('translations'):
      utils.loadSystemFile( 'translations', '../js.cms.settings/translations.json' , translatePage );
    break;
    case !utils.getGlobalVariable('gitApi'):
      doLogin(document.getElementById('content'));
    break;
    case !utils.getGlobalVariable('SEOFields'):
      utils.loadSystemFile( 'SEOFields', '../js.cms.settings/SEOFields.json' , routeToCall );
    break;
    ...
    case !utils.getGlobalVariable('contentTypes'):
      utils.loadSystemFile( 'contentTypes', '../js.cms.settings/contentTypes.json', function(){
